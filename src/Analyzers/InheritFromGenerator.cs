...
public class InheritFromGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(
            ...
            {
                var (declaration, targetSymbol, semanticModel, relatedTypeSymbol, attributes) = syntaxContext;
...
//                );
    ...
    class RuleExpressionVisitor(ImmutableHashSet<string> excludedMembers) : CSharpSyntaxWalker
    {
        ...
        public override void VisitInvocationExpression(InvocationExpressionSyntax node)
        {
            ...
            if (parent is not InvocationExpressionSyntax parentNode) throw new Exception("Unable to find invocation node");
            switch (node)
            {
                case
                {
                ...
                case
                {
                    ...
                    var (predicate2, whenAction2) = parentNode
