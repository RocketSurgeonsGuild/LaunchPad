...
public partial class NewtonsoftJsonMapper(IOptionsMonitor<JsonSerializerOptions> jsonSerializerOptions)
{
    ...
    /// <returns>
    ///     A <see cref="JsonElement" /> representation of the <see cref="JObject" />, or the default <see cref="JsonElement" /> if the <see cref="JObject" /> is
    ///     null.
    /// </returns>
    public JsonElement FromJObject(JObject? source)
    {
        return source == null ? default : JsonDocument.Parse(WriteToBytes(source)).RootElement.Clone();
    }
    ...
    public JObject? ToJObject(JsonElement source)
    {
    ...
    /// <returns>
    ///     A <see cref="JsonElement" /> representation of the <see cref="JArray" />, or the default <see cref="JsonElement" /> if the <see cref="JArray" /> is
    ///     null.
    /// </returns>
    public JsonElement FromJArray(JArray? source)
    {
        return source == default ? default : JsonDocument.Parse(WriteToBytes(source)).RootElement.Clone();
    }
    ...
    public JArray? ToJArray(JsonElement source)
    {
        return source.ValueKind == JsonValueKind.Undefined
            ? default
    ...
    /// <returns>
    ///     A <see cref="JsonElement" /> representation of the <see cref="JToken" />, or the default <see cref="JsonElement" /> if the <see cref="JToken" /> is
    ///     null.
    /// </returns>
    public JsonElement FromJToken(JToken? source)
    {
        return source == null ? default : JsonDocument.Parse(WriteToBytes(source)).RootElement.Clone();
    }
    ...
    public JToken? ToJToken(JsonElement source)
    {
        return source.ValueKind == JsonValueKind.Undefined
            ? default
