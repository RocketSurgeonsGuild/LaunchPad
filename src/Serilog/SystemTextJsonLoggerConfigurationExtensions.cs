...
public static class SystemTextJsonLoggerConfigurationExtensions
{
    ...
    public static LoggerConfiguration SystemTextJsonTypes(this LoggerDestructuringConfiguration configuration) => configuration.With<SystemTextJsonDestructuringPolicy>();
}
