...
public class PeriodAssertions : ReferenceTypeAssertions<Period, PeriodAssertions>
{
    ...
    {
        return ExecuteAssertion(Subject != null && Subject == expected, "to be", expected, because, becauseArgs);
    }
    ...
    {
        return ExecuteAssertion(Subject != null && Subject != expected, "to not be", expected, because, becauseArgs);
    }
