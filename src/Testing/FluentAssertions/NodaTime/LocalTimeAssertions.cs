...
public class LocalTimeAssertions
{
    ...
    private AndConstraint<LocalTimeAssertions> ExecuteAssertion(
        bool condition, string description, LocalTime expected, string? because = null, params object[] becauseArgs
    )
    {
        Execute.Assertion
