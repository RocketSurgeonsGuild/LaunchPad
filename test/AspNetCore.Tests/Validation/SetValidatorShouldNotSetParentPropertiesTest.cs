...
public class SetValidatorShouldNotSetParentPropertiesTest : UnitTestBase
{
    ...
    public void SetValidatorShouldNotSetParentProperties()
    {
        ...
        modelSchema.Required.Should().BeEmpty("No required in Model");
        ...
        subModelSchema.Required.Should().Contain(nameof(SubModel.ListItems), "ListItems is required in SubModel");
