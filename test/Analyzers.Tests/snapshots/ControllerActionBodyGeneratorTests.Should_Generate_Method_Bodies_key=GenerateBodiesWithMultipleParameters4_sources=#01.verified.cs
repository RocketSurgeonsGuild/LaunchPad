...
namespace MyNamespace.Controllers
{
    public partial class RocketController
    {
        ...
        public partial async Task<ActionResult<LaunchRecordModel>> GetRocketLaunchRecord(Guid id, string launchRecordId, [Bind()][BindRequired][FromRoute] GetRocketLaunchRecord.Request request)
        {
