...
namespace MyNamespace.Controllers
{
    public partial class RocketController
    {
        ...
        [ProducesResponseType(typeof(ProblemDetails), 400)]
        [ProducesResponseType(typeof(FluentValidationProblemDetails), 422)]
        public partial async Task<ActionResult> GetRocketLaunchRecord(Guid id, Guid launchRecordId, [Bind(), CustomizeValidator(Properties = "")][BindRequired][FromRoute] GetRocketLaunchRecord.Request request)
        {
