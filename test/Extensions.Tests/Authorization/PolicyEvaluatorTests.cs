...
public class PolicyEvaluatorTests
{
    ...
    public async Task AuthorizeSucceedsEvenIfAuthenticationFails()
    {
        ...
        // Act
        var result = await evaluator.AuthorizeAsync(policy, AuthenticateResult.Fail("Nooo"), context, null);
    ...
    public async Task AuthorizeSucceedsOnlyIfResourceSpecified()
    {
        ...
        // Act
        var result = await evaluator.AuthorizeAsync(policy, success, context, null);
        var result2 = await evaluator.AuthorizeAsync(policy, success, context, new object());
    ...
    public async Task AuthorizeForbidsIfAuthenticationSuceeds()
    {
        ...
        var result = await evaluator.AuthorizeAsync(
            policy, AuthenticateResult.Success(new AuthenticationTicket(new ClaimsPrincipal(), "scheme")), context, null
        );
