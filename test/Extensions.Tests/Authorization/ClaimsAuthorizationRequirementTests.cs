...
public class ClaimsAuthorizationRequirementTests
{
    ...
    public void ToString_ShouldReturnAndDescriptionWhenAllowedValuesNotNull()
    {
        ...
        // Assert
        Assert.Equal(
            "ClaimsAuthorizationRequirement:Claim.Type=Custom and Claim.Value is one of the following values: (CustomValue1|CustomValue2)", formattedValue
        );
    }
    ...
    {
        // Arrange
        var requirement = CreateRequirement("Custom", null);
