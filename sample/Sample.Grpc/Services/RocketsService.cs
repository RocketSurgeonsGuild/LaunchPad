...
namespace Sample.Grpc.Services
{
    public class RocketsService : Rockets.RocketsBase
    {
        ...
        public override async Task<ListRocketsResponse> ListRockets(ListRocketsRequest request, ServerCallContext context)
        {
            ...
            {
                Results = { response.Map(_mapper.Map<RocketModel>) }
            };
        }
        ...
        class CreateRocketRequestValidator : AbstractValidator<CreateRocketRequest>
        {
        ...
        class GetRocketRequestValidator : AbstractValidator<GetRocketRequest>
        {
        ...
        class UpdateRocketRequestValidator : AbstractValidator<UpdateRocketRequest>
        {
        ...
        class ListRocketsRequestValidator : AbstractValidator<ListRocketsRequest>
        {

        }

        class DeleteRocketRequestValidator : AbstractValidator<DeleteRocketRequest>
        {
