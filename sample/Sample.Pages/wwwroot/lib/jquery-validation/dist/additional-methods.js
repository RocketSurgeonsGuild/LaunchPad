...
(function (factory) {
    ...
    $.validator.addMethod(
        ...
        function (phone_number, element) {
            ...
            return (
                this.optional(element) ||
                (phone_number.length > 9 && phone_number.match(/^(?:(?:(?:00\s?|\+)44\s?|0)7(?:[1345789]\d{2}|624)\s?\d{3}\s?\d{3})$/))
            );
        },
        'Please specify a valid mobile number'
    );
    ...
    $.validator.addMethod(
        ...
        function (phone_number, element) {
            ...
            return (
                this.optional(element) ||
                (phone_number.length > 9 && phone_number.match(/^(?:(?:(?:00\s?|\+)44\s?|0)(?:1\d{8,9}|[23]\d{9}|7(?:[1345789]\d{8}|624\d{6})))$/))
            );
        },
