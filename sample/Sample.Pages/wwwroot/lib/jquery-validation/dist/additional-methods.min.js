...
!(function (a) {
    ...
    return (
        ...
        a.validator.addMethod(
            ...
            function (a, b) {
                return (
                    this.optional(b) || /^[1-4]\d{3}\/((0?[1-6]\/((3[0-1])|([1-2][0-9])|(0?[1-9])))|((1[0-2]|(0?[7-9]))\/(30|([1-2][0-9])|(0?[1-9]))))$/.test(a)
                );
            },
        ...
        a.validator.addMethod(
            ...
            function (a, b) {
                return (
                    (a = a.replace(/\s+/g, '')),
                    this.optional(b) ||
                        (a.length > 9 && a.match(/^(\+?1-?)?(\([2-9]([02-9]\d|1[02-9])\)|[2-9]([02-9]\d|1[02-9]))-?[2-9]([02-9]\d|1[02-9])-?\d{4}$/))
                );
            },
            'Please specify a valid phone number'
        ),
